...
public class ChartModel {
	...
	public void setInstrument(Instrument instrument) {
		...
		firePropertyChange(ChartController.INSTRUMENT_PROPERTY, oldValue, instrument);
	}
	...
	public void setTickBarSize(TickBarSize tickBarSize) {
		TickBarSize oldValue = this.tickBarSize;
		this.tickBarSize = tickBarSize;

		firePropertyChange(ChartController.TICK_BAR_SIZE_PROPERTY, oldValue, tickBarSize);
	}
	...
	/**
	 * @param offer side the offer side to set
	 */
	public void setOfferSide(OfferSide offerSide) {
		OfferSide oldValue = this.offerSide;
		this.offerSide = offerSide;

		firePropertyChange(ChartController.OFFER_SIDE_PROPERTY, oldValue, offerSide);
	}
	...
	public void setStartTime(Long startTime) {
		...
		firePropertyChange(ChartController.START_TIME_PROPERTY, oldValue, startTime);
	}
	...
	public void setHighRate(Double highRate) {
		...
		firePropertyChange(ChartController.HIGH_RATE_PROPERTY, oldValue, highRate);
	}
}